...
const UpdateDonReq = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const createDonReq = await axiosPublic.patch(
      `/createDonationRequest/${_id}`,
      createDonationReq
    );
    if (createDonReq.data.modifiedCount > 0) {
      reset();
      Swal.fire({
        position: "top-end",
        icon: "success",
  ...
  return (
    <>
      <div className="mt-20 mb-12">
        <TitleSection heading="Update Donation Request" />
      </div>
      <div>
        <Helmet>
